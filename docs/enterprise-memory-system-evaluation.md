...
| Fixed images | Core `sha256:fded9d48...`；Proxy `sha256:55fedae3...`；Hub `sha256:a6037724...`；tools `sha256:8ca1a2a8...`；OpenCode `sha256:263a6d0e...` | replacement images Ready；`89398d1d` cleanup 后 active images 7/7 retained；full Mock Blocked |
...
| OpenCode | `1.18.16` / image `sha256:263a6d0eade24b72b4b2627984a930fc69a3e621519b1ec050a0320398b890a1` | fixed-title TDD、单次 rebuild、version/help、UID10001、host/image hash、evidence ownership/writability Passed；typed diagnostic `89398d1d` Passed/cleaned；normal headless exact verifier/evidence publish 未证明，full Mock Blocked |
