...
> 依据：[负责人原则](../foundations/owner-principles.md)（最高优先级）、
> [Agent 记忆管理全景](../research/reports/2026-08-03-agent-memory-landscape.md)、
> [治理补充调研](../research/reports/2026-08-06-agent-memory-governance-supplement.md)、
> [全景调研评审](../research/reports/2026-08-03-agent-memory-landscape-review.md) 与 [独立分析](../research/reports/2026-08-06-agent-memory-independent-analysis.md)
...
- **独立知识库让知识与代码解耦**:知识库可以有独立的提交历史与权限，也可以随项目仓库一起获取；是否采用 submodule 应由实际项目的权限与交付方式决定，本调研仓库不承载该实现；
