...
| 入口 | 用途 | 当前状态 |
| --- | --- | --- |
| [企业智能体记忆系统评估](enterprise-memory-system-evaluation.md) | 当前范围、风险、下一 Gate | full Mock `full-6449fcf8` step 11 Blocked/cleaned；diagnostic `1080bc3e` `phase=observation` Blocked/cleaned；TUI/real Not Run |
...
| [Task 5 deterministic Mock stepfix-2df660d8 Ready](reproduction/2026-08-12-task5-mock-20260812-stepfix-2df660d8-ready.md) | fixed-step launcher 后的全新 tuple、7-image/config/port/label freshness | Ready/Not Run；仅允许单次 tracked 17-step run |
| [Task 5 deterministic Mock stepfix-2df660d8 OpenCode write Blocked](reproduction/2026-08-12-task5-mock-20260812-stepfix-2df660d8-opencode-write-blocked.md) | 单次 launcher 的固定 step 9 fail-stop、脱敏盘点与 OpenCode auto-title 根因 | Blocked；steps 1–8 exit 0；后续 steps/TUI/real Not Run |
...
| [Task 5 OpenCode typed diagnostic 89398d1d Ready](reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-ready.md) | typed launcher TDD/review 后的新唯一 tuple 与 labels/evidence/port/images/overlay preflight | Ready/Not Run；仅允许一次 tracked canonical diagnostic |
| [Task 5 OpenCode typed diagnostic 89398d1d Passed](reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-passed.md) | canonical code0、render/spawn/capture、Proxy DNS/TCP、exact Mock operation/main 与 leak flags | Runtime Passed（single OpenCode typed diagnostic only）；normal headless verifier/evidence publish 未证明 |
| [Task 5 OpenCode typed diagnostic 89398d1d exact cleanup Passed](reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-exact-cleanup-passed.md) | exact profiled project cleanup 与独立 after-query | Runtime Cleanup Passed；5/1/9 → 0/0/0；active images 7/7 retained |
| [Task 5 OpenCode normal headless phase diagnostic a666e597 Ready](reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-ready.md) | exact verifier/evidence publish wrapper、prior Claude baseline 与全新 tuple preflight | Ready/Not Run；仅允许一次 tracked phase diagnostic |
| [Task 5 OpenCode normal headless phase diagnostic a666e597 Passed](reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-passed.md) | prior Claude baseline 后的 normal OpenCode client、exact verifier 与 atomic evidence publish | Runtime Passed（single phase diagnostic only）；full Mock Not Run |
| [Task 5 OpenCode normal headless phase diagnostic a666e597 exact cleanup Passed](reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-exact-cleanup-passed.md) | exact profiled project cleanup 与独立 after-query | Runtime Cleanup Passed；5/1/12 → 0/0/0；active images 7/7 retained |
| [Task 5 deterministic Mock full-6449fcf8 Ready](reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-ready.md) | full 17-step launcher 的新唯一 tuple 与 Git/labels/evidence/port/images/config freshness | Ready/Not Run；仅允许一次 tracked full Mock |
| [Task 5 deterministic Mock full-6449fcf8 Claude read Blocked](reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-claude-read-blocked.md) | single launcher fixed step 11；steps 1–10、三 writes 与未运行边界 | Blocked；首个 Claude cross-owner read；后续五读/final Not Run |
| [Task 5 deterministic Mock full-6449fcf8 exact cleanup Passed](reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-exact-cleanup-passed.md) | exact profiled cleanup 与独立 after-query | Runtime Cleanup Passed；5/1/15 → 0/0/0；active images 7/7 retained |
| [Task 5 Claude cross-owner read diagnostic 1080bc3e Ready](reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-ready.md) | 精确重放 steps 1–10、仅最终 Claude read 应用 phase overlay 的新 tuple 与静态/freshness preflight | Ready/Not Run；仅允许一次 tracked diagnostic；业务 Gate 仍 Blocked |
| [Task 5 Claude cross-owner read diagnostic 1080bc3e observation Blocked](reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-observation-blocked.md) | single launcher 将最终 read 收窄到 aggregate observation 或 exact verifier | Diagnostic Blocked；`phase=observation`；业务 Gate 仍 Blocked |
| [Task 5 Claude cross-owner read diagnostic 1080bc3e exact cleanup Passed](reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-exact-cleanup-passed.md) | exact profiled cleanup、独立 after-query 与 full image ID 复核 | Runtime Cleanup Passed；5/1/15 → 0/0/0；active images 7/7 retained |
...
| [集成实验 SOP](../tests/integration/README.md) | 后续静态验证与受控运行入口 | step 11 Blocked/cleaned；diagnostic `1080bc3e` observation Blocked/cleaned；下一 Gate 为 observation 子阶段 TDD |
