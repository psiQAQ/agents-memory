...
| 入口 | 用途 | 当前状态 |
| --- | --- | --- |
| [企业智能体记忆系统评估](enterprise-memory-system-evaluation.md) | 当前范围、风险、下一 Gate | `e83748e2` Blocked/cleaned；`stepfix-2df660d8` full Mock Ready/Not Run；TUI/real Not Run |
...
| [集成实验 SOP](../tests/integration/README.md) | 后续静态验证与受控运行入口 | `stepfix-2df660d8` full deterministic Mock Ready/Not Run |
