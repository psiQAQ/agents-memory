...
| 入口 | 用途 | 当前状态 |
| --- | --- | --- |
| [企业智能体记忆系统评估](enterprise-memory-system-evaluation.md) | 当前范围、风险、下一 Gate | Task 5 `a72ae725` host-native-stderr-during-up Blocked；TUI/real Not Run |
...
| [集成实验 SOP](../tests/integration/README.md) | 后续静态验证与受控运行入口 | a72ae725 host-native-stderr-during-up Blocked；TDD/new tuple 待执行；TUI/real Not Run |
