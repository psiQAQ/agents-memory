...
| 入口 | 用途 | 当前状态 |
| --- | --- | --- |
| [企业智能体记忆系统评估](enterprise-memory-system-evaluation.md) | 当前范围、风险、下一 Gate | Task 5 Claude diagnostic Blocked；host-timeout-during-up，TUI/real Not Run |
...
| [集成实验 SOP](../tests/integration/README.md) | 后续静态验证与受控运行入口 | 08c403c6 host-timeout-during-up Blocked；新 tuple 待执行；TUI/real Not Run |
