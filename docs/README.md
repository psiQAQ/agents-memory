...
| 入口 | 用途 | 当前状态 |
| --- | --- | --- |
| [企业智能体记忆系统评估](enterprise-memory-system-evaluation.md) | 当前范围、风险、下一 Gate | `113ca669` Claude diagnostic Passed + exact cleanup；完整 Mock Ready/Not Run；TUI/real Not Run |
...
| [集成实验 SOP](../tests/integration/README.md) | 后续静态验证与受控运行入口 | 113ca669 diagnostic Passed/cleaned；下一 Gate 为全新 tuple 的完整 deterministic Mock |
