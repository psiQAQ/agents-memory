...
| 阶段 | 客户端 | 协议与状态 |
| --- | --- | --- |
| Stage 1 | Claude Code `2.1.226`、OpenCode `1.18.16`、Pi `0.84.1` | `opentitle-4f056ee6` step 9 Blocked 且 exact cleanup；OpenCode typed diagnostic `89398d1d` Ready/Not Run；TUI/real Not Run |
...
**Boundary**：Task 5 Proxy `9e456a5/sha256:55fedae3...`、tools `sha256:8ca1a2a8...`、Claude `sha256:261a9173...` 与 OpenCode fixed-title `sha256:263a6d0e...` 均为 **Ready（build/assets only）**。历史 Blocked records 保持 append-only；[`opentitle-4f056ee6`](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-opencode-write-blocked.md) 的单次 launcher 在 fixed step 9 fail-stop，唯一脱敏 aggregate probe 只证明 OpenCode main request 精确一次到达 Mock，未定位具体失败项；随后已完成 [exact cleanup](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-exact-cleanup-passed.md)。OpenCode typed diagnostic 已完成 TDD/static review；[`89398d1d` Ready](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-ready.md) 固定全新 tuple 与 preflight，尚未运行。当前业务 Gate 仍为 **Blocked**。完整三写六读、final、TUI、真实模型与 Codex Stage 2 均为 **Not Run**。旧 Windows + Claude 方案及其运行记录均归档为 **Legacy**。

## 起点

1. 阅读 [项目指令](CLAUDE.md)、[文档索引](docs/README.md) 和 [当前评估](docs/enterprise-memory-system-evaluation.md)。
2. 阅读 [四 Docker CLI 实施计划](docs/superpowers/plans/2026-08-10-four-docker-cli-memory.md)、[架构 ADR](docs/decisions/2026-08-10-four-docker-cli-baseline.md)、[Task 5 privacy/build Passed](docs/reproduction/2026-08-11-task5-proxy-privacy-build-passed.md)、[pre-runtime round 1 erratum](docs/reproduction/2026-08-11-task5-pre-runtime-review-round1-erratum.md)、[root static Passed](docs/reproduction/2026-08-11-task5-pre-runtime-review-round1-root-static-passed.md)、[OpenCode replacement Passed](docs/reproduction/2026-08-12-task5-opencode-title-replacement-image-passed.md)、[opentitle OpenCode write Blocked](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-opencode-write-blocked.md)、[opentitle exact cleanup](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-exact-cleanup-passed.md) 与 [OpenCode typed diagnostic Ready](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-ready.md)。
