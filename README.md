...
| 阶段 | 客户端 | 协议与状态 |
| --- | --- | --- |
| Stage 1 | Claude Code `2.1.226`、OpenCode `1.18.16`、Pi `0.84.1` | `opentitle-4f056ee6` step 9 Blocked/cleaned；typed diagnostic `89398d1d` Passed/cleaned；normal headless phase diagnostic `a666e597` Ready/Not Run；TUI/real Not Run |
...
**Boundary**：Task 5 Proxy `9e456a5/sha256:55fedae3...`、tools `sha256:8ca1a2a8...`、Claude `sha256:261a9173...` 与 OpenCode fixed-title `sha256:263a6d0e...` 均为 **Ready（build/assets only）**。历史 Blocked records 保持 append-only；[`opentitle-4f056ee6`](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-opencode-write-blocked.md) 的单次 launcher在 fixed step 9 fail-stop并已 [exact cleanup](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-exact-cleanup-passed.md)。OpenCode typed diagnostic `89398d1d` 已 [Passed](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-passed.md) 并完成 [exact cleanup](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-exact-cleanup-passed.md)，但不证明普通 headless exact verifier/evidence publish。normal headless fixed-phase diagnostic 已通过 TDD/static review；全新 [`a666e597` Ready](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-ready.md) tuple 只允许单次 tracked run。当前业务 Gate 仍为 **Blocked**；完整三写六读、final、TUI、真实模型与 Codex Stage 2 均为 **Not Run**。旧 Windows + Claude 方案及其运行记录均归档为 **Legacy**。

## 起点

1. 阅读 [项目指令](CLAUDE.md)、[文档索引](docs/README.md) 和 [当前评估](docs/enterprise-memory-system-evaluation.md)。
2. 阅读 [四 Docker CLI 实施计划](docs/superpowers/plans/2026-08-10-four-docker-cli-memory.md)、[架构 ADR](docs/decisions/2026-08-10-four-docker-cli-baseline.md)、[Task 5 privacy/build Passed](docs/reproduction/2026-08-11-task5-proxy-privacy-build-passed.md)、[OpenCode replacement Passed](docs/reproduction/2026-08-12-task5-opencode-title-replacement-image-passed.md)、[opentitle OpenCode write Blocked](docs/reproduction/2026-08-12-task5-mock-20260812-opentitle-4f056ee6-opencode-write-blocked.md)、[typed diagnostic Passed](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-passed.md) 与 [normal headless phase diagnostic Ready](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-ready.md)。
