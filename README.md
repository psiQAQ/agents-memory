...
| 阶段 | 客户端 | 协议与状态 |
| --- | --- | --- |
| Stage 1 | Claude Code `2.1.226`、OpenCode `1.18.16`、Pi `0.84.1` | full Mock `full-6449fcf8` step 11 Blocked/cleaned；Claude read diagnostic `1080bc3e` `phase=observation` Blocked/cleaned；TUI/real Not Run |
...
**Boundary**：Task 5 Proxy `9e456a5/sha256:55fedae3...`、tools `sha256:8ca1a2a8...`、Claude `sha256:261a9173...` 与 OpenCode fixed-title `sha256:263a6d0e...` 均为 **Ready（build/assets only）**。normal headless phase diagnostic `a666e597` 已 Passed/cleaned。全新 `full-6449fcf8` 的单次 17-step launcher在 [fixed step 11 Blocked](docs/reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-claude-read-blocked.md) 并已 [exact cleanup](docs/reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-exact-cleanup-passed.md)：steps 1–10 exit `0`，三 writes 通过，但首个 Claude read、后续五读与 final 未通过证明。Claude read fixed-phase coordinator 已通过 focused `51/51`、root `258/258`、Compose `8/8` 与 review `C0/I0/M0`；diagnostic `1080bc3e` 已从 [Ready](docs/reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-ready.md) 单次运行到 [`phase=observation` Blocked](docs/reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-observation-blocked.md)，并完成 [exact cleanup](docs/reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-exact-cleanup-passed.md)。该分类不能区分 fetch/continuity/delta/path/marker；下一动作是按 TDD 新增 observation 子阶段 fixed diagnostic并使用全新 tuple，不得重跑旧 tuple/full Mock。TUI、真实模型与 Codex Stage 2 仍为 **Not Run**。

## 起点

1. 阅读 [项目指令](CLAUDE.md)、[文档索引](docs/README.md) 和 [当前评估](docs/enterprise-memory-system-evaluation.md)。
2. 阅读 [四 Docker CLI 实施计划](docs/superpowers/plans/2026-08-10-four-docker-cli-memory.md)、[架构 ADR](docs/decisions/2026-08-10-four-docker-cli-baseline.md)、[Task 5 privacy/build Passed](docs/reproduction/2026-08-11-task5-proxy-privacy-build-passed.md)、[normal headless phase diagnostic Passed](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-passed.md)、[full Mock step 11 Blocked](docs/reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-claude-read-blocked.md)、[full Mock exact cleanup](docs/reproduction/2026-08-12-task5-mock-20260812-full-6449fcf8-exact-cleanup-passed.md)、[Claude read diagnostic observation Blocked](docs/reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-observation-blocked.md) 与 [对应 exact cleanup](docs/reproduction/2026-08-12-task5-diag-claude-read-20260812-1080bc3e-exact-cleanup-passed.md)。
