...
| 阶段 | 客户端 | 协议与状态 |
| --- | --- | --- |
| Stage 1 | Claude Code `2.1.226`、OpenCode `1.18.16`、Pi `0.84.1` | normal headless phase diagnostic `a666e597` Passed/cleaned；fresh full Mock preflight next；TUI/real Not Run |
...
**Boundary**：Task 5 Proxy `9e456a5/sha256:55fedae3...`、tools `sha256:8ca1a2a8...`、Claude `sha256:261a9173...` 与 OpenCode fixed-title `sha256:263a6d0e...` 均为 **Ready（build/assets only）**。历史 Blocked records 保持 append-only；typed diagnostic `89398d1d` 已 [Passed](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-passed.md) 并 cleaned。normal headless phase diagnostic `a666e597` 已从 [Ready](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-ready.md) 单次运行到 [Passed](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-passed.md)，并完成 [exact cleanup](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-exact-cleanup-passed.md)：prior Claude operation 后的 OpenCode client、exact verifier 与 atomic evidence publish 均成功。它仍不是完整 Mock Gate；当前状态为 **Blocked / fresh full Mock preflight next**。完整三写六读、final、TUI、真实模型与 Codex Stage 2 均为 **Not Run**。

## 起点

1. 阅读 [项目指令](CLAUDE.md)、[文档索引](docs/README.md) 和 [当前评估](docs/enterprise-memory-system-evaluation.md)。
2. 阅读 [四 Docker CLI 实施计划](docs/superpowers/plans/2026-08-10-four-docker-cli-memory.md)、[架构 ADR](docs/decisions/2026-08-10-four-docker-cli-baseline.md)、[Task 5 privacy/build Passed](docs/reproduction/2026-08-11-task5-proxy-privacy-build-passed.md)、[OpenCode replacement Passed](docs/reproduction/2026-08-12-task5-opencode-title-replacement-image-passed.md)、[typed diagnostic Passed](docs/reproduction/2026-08-12-task5-diag-opencode-20260812-89398d1d-passed.md)、[normal headless phase diagnostic Passed](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-passed.md) 与 [exact cleanup](docs/reproduction/2026-08-12-task5-diag-opencode-headless-20260812-a666e597-exact-cleanup-passed.md)。
