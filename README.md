...
| 阶段 | 客户端 | 协议与状态 |
| --- | --- | --- |
| Stage 1 | Claude Code `2.1.226`、OpenCode `1.18.16`、Pi `0.84.1` | `opentitle-4f056ee6` step 9 Blocked 且 exact cleanup；OpenCode typed diagnostic pending；TUI/real Not Run |
