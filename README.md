...
| 阶段 | 客户端 | 协议与状态 |
| --- | --- | --- |
| Stage 1 | Claude Code `2.1.226`、OpenCode `1.18.16`、Pi `0.84.1` | full Mock `full-6449fcf8` step 11 Blocked/cleaned；Claude read diagnostic `1080bc3e` Ready/Not Run；TUI/real Not Run |
