...
完整前置链见 [privacy/build Passed](../../docs/reproduction/2026-08-11-task5-proxy-privacy-build-passed.md)、[root static Passed](../../docs/reproduction/2026-08-11-task5-pre-runtime-review-round1-root-static-passed.md)、[08c403c6 diagnostic Ready](../../docs/reproduction/2026-08-11-task5-diag-claude-p-20260811-08c403c6-ready.md) 与 [08c403c6 host-timeout Blocked](../../docs/reproduction/2026-08-11-task5-diag-claude-p-20260811-08c403c6-host-timeout-during-up-blocked.md)。下一 Gate 为 cleanup 后的新 tuple、long-lived async exec 与 direct structured JSON parser 的 Claude write diagnostic；不得从当前 timeout 推断 JSON/classification/root cause，不重跑/TUI/real。
